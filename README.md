...
![程序界面](assets/screenshot_ui.png)
*程序主界面 — 选择图片后可通过参数面板调整配色参数*

![配色结果示例](assets/scheme_example.png)
*生成的配色结果图示例 — 包含主题色、方案对比及线颜色矩阵*
...
- 音符颜色、背景色、UI/特效颜色
- 线颜色行×列矩阵（每行=同色系，横向亮度渐变）
- 全部线颜色总览（底部额外展示从全色池按色系生成的整体线颜色矩阵）
- 所有色块标注 RGB 和十六进制色号
- `multiple` 模式下每主题同时展示标准/高对比/柔和三套方案
